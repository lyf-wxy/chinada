...
(function(c) {
    ...
    function z(a, b, h, l, f, k, p, u, g) {
        ...
        h.currentImg = c("#contentHolderUnit_" + v, k),
        h.currentImg.css("z-index", h.currentZ_index),
        m == Math.floor(b.numberOfVisibleItems / 2) && (1 === a ? (E(h.currentImg, m + 1, b, h), h.currentImg.css({
            ...
            opacity: 0
        })) : (last_aux_img_no = B(v, 1, p), last_currentImg = c("#contentHolderUnit_" + last_aux_img_no, k), j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width), d = parseInt(j * h.aspectOrig, 10), n = parseInt((b.width - b.contentHolderUnitOrigWidth / (b.origWidth / b.width)) / 2, 10) + (b.contentHolderUnitOrigWidth / (b.origWidth / b.width) + (m + 1) * b.elementsHorizontalSpacing / (b.origWidth / b.width) - d), q = parseInt(b.height - b.contentHolderUnitOrigHeight / (b.origWidth / b.width), 10) - b.verticalAdjustment / (b.origWidth / b.width) + (m + 1) * b.elementsVerticalSpacing / (b.origWidth / b.width), C(last_currentImg, n, q, d, j, 0, !1, a, h, b, g, f, p, u, l, k))),
        h.currentImg.css("display", "block"),
        j = b.contentHolderUnitOrigHeight / (b.origWidth / b.width) - 2 * m * b.elementsVerticalSpacing / (b.origWidth / b.width),
        d = parseInt(j * h.aspectOrig, 10),
    ...
    function C(a, b, h, l, f, k, p, u, g, d, j, n, q, v, x, r) {
        ...
        function() {
            if (p) {
                ...
                if (0 < d.autoPlay && 1 < q && !g.mouseOverBanner && !g.fastForwardRunning || g.current_img_no != g.img_no_where_to_stop && g.fastForwardRunning) clearTimeout(g.timeoutID),
    ...
    c.fn.allinone_carousel = function(a) {
        a = c.extend({},
        c.fn.allinone_carousel.defaults, a);
        return this.each(function() {
            ...
            for (m = 1; m <= Math.floor(a.numberOfVisibleItems / 2); m++) e.currentZ_index--,
            ...
            g.mousedown(function() {
                D = !0; ! e.slideIsRunning && !e.fastForwardRunning && (e.isVideoPlaying = !1, clearTimeout(e.timeoutID), z( - 1, a, e, y, t, f, s, r, x))
            });
            g.mouseup(function() {
                D = !1
            });
            ...
            c(window).resize(function() {
                ...
                a.responsive && doResizeNow && (!1 !== G && clearTimeout(G), G = setTimeout(function() {
                    ...
                    if (d.origWidth != responsiveWidth || d.width100Proc) d.origWidth > responsiveWidth || d.width100Proc ? d.width = responsiveWidth: d.width100Proc || (d.width = d.origWidth),
                    ...
                    k.width(d.width),
                    k.height(d.height),
                    d.enableTouchScreen && (f.parent().width(d.width + 1), f.parent().height(d.height)),
                    ...
                    x.css("top", parseInt(d.elementOrigTop / (d.origWidth / d.width), 10)),
                    clearTimeout(e.timeoutID),
